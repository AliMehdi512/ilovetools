...
setup(
    ...
    keywords="utilities, tools, ai, ml, data-processing, automation, python-library, neural-networks, gradient-descent, optimization, regularization, loss-functions, activation-functions",
    project_urls={
