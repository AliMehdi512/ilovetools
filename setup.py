...
setup(
    ...
    keywords="utilities, tools, ai, ml, data-processing, automation, python-library, neural-networks, transfer-learning, fine-tuning, pretrained-models, feature-extraction, domain-adaptation, imagenet, bert, gpt, resnet, few-shot-learning, discriminative-learning-rates, gradual-unfreezing, deep-learning, pytorch, tensorflow",
    project_urls={
