...
setup(
    ...
    keywords="utilities, tools, ai, ml, data-processing, automation, python-library, neural-networks, learning-rate-schedulers, optimization, adaptive-learning-rate, cosine-annealing, onecycle, sgdr, deep-learning",
    project_urls={
