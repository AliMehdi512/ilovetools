...
setup(
    ...
    keywords="utilities, tools, ai, ml, data-processing, automation, python-library, neural-networks, transformers, positional-encoding, attention-mechanism, multi-head-attention, rope, alibi, deep-learning, nlp",
    project_urls={
